            ...
            <div className="bg-yellow-50 rounded p-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex gap-1">
                  {/* 一覧はteacherIdパラメータ付きで常に表示 */}
                  <a
                    href={`/admin/follow-mails/user/${id}?teacherId=${pageTeacherId}`}
                    className="text-xs bg-yellow-400 hover:bg-yellow-500 text-white px-2 py-0.5 rounded"
                  >一覧</a>
                  {/* 作成はcanEditのみ */}
                  {canEdit ? (
